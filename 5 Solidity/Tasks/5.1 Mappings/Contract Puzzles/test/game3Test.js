...
describe('Game3', function () {
  ...
  it('should be a winner', async function () {
    ...
    await game.connect(signer3).buy({ value: ethers.utils.parseEther('0.001') });
    await game.connect(signer1).buy({ value: ethers.utils.parseEther('0.01') });
    await game.connect(signer2).buy({ value: ethers.utils.parseEther('0.1') });
